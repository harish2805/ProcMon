...
BOOL ThreadInfo::ThreadsDisplay()
{
    ...
    cout<<endl<<"TREAD OF THIS PROCESS:"<<endl;
    do
    {
...
BOOL DLLInfo::DependentDLLDisplay()
{
    ...
    do
    {
        wcstombs(NULL,arr,200,me32.szModule,200);
        cout<<arr<<endl;
...
BOOL ProcessInfo::ProcessLog()
{
    ...
    sprintf(FileName,"C://MarvellousLog %02d_%2d%s.txt",It.wHour,It.wMinute,It.wDay,month[It.wMonth-1]);
    ...
    do
    {
        wcstombs(NULL,arr,200,pe32.szExeFile,200);
...
BOOL ProcessInfo::ReadLog(DWORD hr,DWORD min,DWORD date,DWORD month)
{
    ...
    sprintf(FileName,"c://MarvellousLog %02d_%02d_%02d%s.txt",hr,min,date,montharr[month-1]);
...
BOOL HardwareInfo()
{
    ...
    cout<<"Minimum application address:"<<siSysInfo.IpMinimumApplicationAddress<<endl;
    cout<<"Maximum application address:"<<siSysInfo.IpMaximumApplicationAddress<<endl;
    cout<<"Activate processor mask:"<<siSysInfo.dwActiveProcessorMask<<endl;
